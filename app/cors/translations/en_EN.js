...
app.config(['$translateProvider', function($translateProvider) {
    $translateProvider.translations('en_EN', {
        ...
        'USER.PROFIL_PICTURE': 'Profile picture',
        'USER.AVATAR_SAVED': 'The profile picture saved',
        'USER.AVATAR_REMOVED': 'The profile picture removed',
        'USER.AVATAR_EMPTY': 'The profile picture can not be empty',
        ...
        'USER.CHANGE_AVATAR': 'Change my profile picture',
